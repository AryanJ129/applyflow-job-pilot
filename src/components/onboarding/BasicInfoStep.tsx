...
const BasicInfoStep = ({ data, onUpdate }: BasicInfoStepProps) => {
  ...
  const generateAISummary = () => {
    ...
    const sampleSummary = `Motivated ${data.jobTitle || 'professional'} eager to contribute to team success through hard work, attention to detail, and excellent organizational skills. Clear understanding of industry best practices and passionate about continuous learning and professional development.`;
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          Tell us about yourself to personalize your ApplyFlow experience
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <Textarea
            id="summary"
            placeholder="Write a brief summary about yourself, your goals, and what you're looking for in your career..."
            value={data.summary}
